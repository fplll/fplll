...
is_lll_reduced<Z_NR<long>, FP_NR<long double>>(MatGSOInterface<Z_NR<long>, FP_NR<long double>> &m,
                                                double delta, double eta);
template bool
is_lll_reduced<Z_NR<double>, FP_NR<long double>>(MatGSOInterface<Z_NR<double>, FP_NR<long double>> &m,
                                                double delta, double eta);
#endif
...
is_lll_reduced<Z_NR<mpz_t>, FP_NR<dpe_t>>(MatGSOInterface<Z_NR<mpz_t>, FP_NR<dpe_t>> &m,
                                          double delta, double eta);
template bool
is_lll_reduced<Z_NR<long>, FP_NR<dpe_t>>(MatGSOInterface<Z_NR<long>, FP_NR<dpe_t>> &m,
                                         double delta, double eta);
template bool
