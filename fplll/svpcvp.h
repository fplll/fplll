 ...
 */
int shortest_vector(ZZ_mat<mpz_t> &b, vector<Z_NR<mpz_t>> &sol_coord, SVPMethod method = SVPM_PROVED,
 ...
 */
int closest_vector(ZZ_mat<mpz_t> &b, const vector<Z_NR<mpz_t>> &int_target, vector<Z_NR<mpz_t>> &sol_coord,
