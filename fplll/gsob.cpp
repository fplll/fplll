...
inline void MatGSOb<ZT, FT>::invalidate_gso_row(int i, int new_valid_cols)
{
...
template <class ZT, class FT> void MatGSOb<ZT, FT>::row_op_end(int first, int last)
{
#ifdef DEBUG
...
template <class ZT, class FT> inline ZT MatGSOb<ZT, FT>::get_max_gram()
{
  ZT tmp;
  if (enable_int_gram)
  {
...
template <class ZT, class FT> inline FT MatGSOb<ZT, FT>::get_max_bstar()
{
  FT tmp;
  tmp = r(0, 0);
  for (int i = 0; i < n_known_rows; i++)
...
template <class ZT, class FT> long MatGSOb<ZT, FT>::get_max_mu_exp(int i, int n_columns)
{
...
/*
template <class ZT, class FT>
void MatGSOb<ZT, FT>::row_addmul_we(int i, int j, const FT &x, long expo_add)
{
...
template <class ZT, class FT> bool MatGSOb<ZT, FT>::update_gso_row(int i, int last_j)
{
...
template <class ZT, class FT> void MatGSOb<ZT, FT>::lock_cols() { cols_locked = true; }

template <class ZT, class FT> void MatGSOb<ZT, FT>::unlock_cols()
{
...
template <class ZT, class FT>
void MatGSOb<ZT, FT>::apply_transform(const Matrix<FT> &transform, int src_base, int target_base)
{
...
template <class ZT, class FT> double MatGSOb<ZT, FT>::get_current_slope(int start_row, int stop_row)
{
  FT f, log_f;
  long expo;
  vector<double> x;
...
template <class ZT, class FT> FT MatGSOb<ZT, FT>::get_root_det(int start_row, int end_row)
{
...
template <class ZT, class FT> FT MatGSOb<ZT, FT>::get_log_det(int start_row, int end_row)
{
  FT log_det = 0.0;
  start_row  = max(0, start_row);
  end_row    = min(d, end_row);
...
template <class ZT, class FT>
FT MatGSOb<ZT, FT>::get_slide_potential(int start_row, int end_row, int block_size)
{
  FT potential = 0.0;
...
template class MatGSOb<Z_NR<long>, FP_NR<double>>;
template class MatGSOb<Z_NR<double>, FP_NR<double>>;
template class MatGSOb<Z_NR<mpz_t>, FP_NR<double>>;
...
template class MatGSOb<Z_NR<long>, FP_NR<long double>>;
template class MatGSOb<Z_NR<double>, FP_NR<long double>>;
template class MatGSOb<Z_NR<mpz_t>, FP_NR<long double>>;
...
#ifdef FPLLL_WITH_QD
template class MatGSOb<Z_NR<long>, FP_NR<dd_real>>;
template class MatGSOb<Z_NR<double>, FP_NR<dd_real>>;
template class MatGSOb<Z_NR<mpz_t>, FP_NR<dd_real>>;
template void adjust_radius_to_gh_bound<FP_NR<dd_real>>(FP_NR<dd_real> &max_dist,
                                                        long max_dist_expo, int block_size,
                                                        const FP_NR<dd_real> &root_det,
                                                        double gh_factor);
template class MatGSOb<Z_NR<long>, FP_NR<qd_real>>;
template class MatGSOb<Z_NR<double>, FP_NR<qd_real>>;
template class MatGSOb<Z_NR<mpz_t>, FP_NR<qd_real>>;
...
template class MatGSOb<Z_NR<long>, FP_NR<dpe_t>>;
template class MatGSOb<Z_NR<double>, FP_NR<dpe_t>>;
template class MatGSOb<Z_NR<mpz_t>, FP_NR<dpe_t>>;
...
template class MatGSOb<Z_NR<long>, FP_NR<mpfr_t>>;
template class MatGSOb<Z_NR<double>, FP_NR<mpfr_t>>;
template class MatGSOb<Z_NR<mpz_t>, FP_NR<mpfr_t>>;
