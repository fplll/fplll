...
template <class ZT, class FT> void MatGGSO<ZT, FT>::discover_row()
{
...
template <class ZT, class FT> void MatGGSO<ZT, FT>::update_bf(int i)
{
  // EMPTY
}

template <class ZT, class FT> void MatGGSO<ZT, FT>::invalidate_gram_row(int i)
{
  // EMPTY
}
...
template <class ZT, class FT> void MatGGSO<ZT, FT>::row_add(int i, int j)
{
  if (enable_transform)
  {
    u[i].add(u[j]);
...
template <class ZT, class FT> void MatGGSO<ZT, FT>::row_sub(int i, int j)
{
  if (enable_transform)
  {
    u[i].sub(u[j]);
...
template <class ZT, class FT> void MatGGSO<ZT, FT>::row_addmul_si(int i, int j, long x)
{
  if (enable_transform)
  {
    u[i].addmul_si(u[j], x);
...
void MatGGSO<ZT, FT>::row_addmul_si_2exp(int i, int j, long x, long expo)
{
...
/*
template <class ZT, class FT>
void MatGGSO<ZT, FT>::row_addmul_2exp(int i, int j, const ZT &x, long expo)
{
...
template <class ZT, class FT>
void MatGGSO<ZT, FT>::row_addmul_we(int i, int j, const FT &x, long expo_add)
{
  ...
  {
    cerr << "Error in ggso.cpp, using exponents while enable_int_gram is on. expo is equal to " << expo << ".\n"; exit(1);
  }
}
*/
...
template <class ZT, class FT> void MatGGSO<ZT, FT>::row_swap(int i, int j)
{
...
template <class ZT, class FT> void MatGGSO<ZT, FT>::move_row(int old_r, int new_r)
{
  ...
  if (new_r < old_r)
  {
    ...
    if (enable_int_gram) 
    {
      if (gptr == nullptr) { cerr << "Error (symmetrize_g): gptr is equal to the nullpointer."; exit(1); }    
...
template <class ZT, class FT> void MatGGSO<ZT, FT>::size_increased()
{
  if (d > alloc_dim)
  {
    if (gptr == nullptr) { cerr << "Error (symmetrize_g): gptr is equal to the nullpointer."; exit(1); }
...
template class MatGGSO<Z_NR<long>, FP_NR<double>>;
template class MatGGSO<Z_NR<double>, FP_NR<double>>;
template class MatGGSO<Z_NR<mpz_t>, FP_NR<double>>;                                           

#ifdef FPLLL_WITH_LONG_DOUBLE
template class MatGGSO<Z_NR<long>, FP_NR<long double>>;
template class MatGGSO<Z_NR<double>, FP_NR<long double>>;
template class MatGGSO<Z_NR<mpz_t>, FP_NR<long double>>;
...
#ifdef FPLLL_WITH_QD
template class MatGGSO<Z_NR<long>, FP_NR<dd_real>>;
template class MatGGSO<Z_NR<double>, FP_NR<dd_real>>;
template class MatGGSO<Z_NR<mpz_t>, FP_NR<dd_real>>;

template class MatGGSO<Z_NR<long>, FP_NR<qd_real>>;
template class MatGGSO<Z_NR<double>, FP_NR<qd_real>>;
template class MatGGSO<Z_NR<mpz_t>, FP_NR<qd_real>>;
//                                                 
#endif

#ifdef FPLLL_WITH_DPE
template class MatGGSO<Z_NR<long>, FP_NR<dpe_t>>;
template class MatGGSO<Z_NR<double>, FP_NR<dpe_t>>;
template class MatGGSO<Z_NR<mpz_t>, FP_NR<dpe_t>>;
//                                               
#endif

template class MatGGSO<Z_NR<long>, FP_NR<mpfr_t>>;
template class MatGGSO<Z_NR<double>, FP_NR<mpfr_t>>;
template class MatGGSO<Z_NR<mpz_t>, FP_NR<mpfr_t>>;
