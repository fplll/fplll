...
Enumerator::Enumerator(int d, const Matrix<FP_NR<>> &mu, const Matrix<FP_NR<>> &r, double argMaxVolume,
                       int min_level)
...
bool Enumerator::enum_next(const FP_NR<> &max_sqr_length)
{
  FP_NR<> newdist, newcenter, y, volume, rtmp1;
  bool notFound = true;
