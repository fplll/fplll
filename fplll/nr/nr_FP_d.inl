...
template<>
inline unsigned int FP_NR<double>::get_min_prec() {return PREC_DOUBLE;}
...
template<>
inline int FP_NR<double>::fits_slong() const {
 return 1;
}
...
template<>
inline void FP_NR<double>::mul_si(const FP_NR<double>& b, long c) {
