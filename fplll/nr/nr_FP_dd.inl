...
/* operators */
template<>
inline FP_NR<dd_real>& FP_NR<dd_real>::operator=(const FP_NR<dd_real>& a) {
  data = a.data;
  return *this;
}

template<>
inline FP_NR<dd_real>& FP_NR<dd_real>::operator=(double a) {
  data = a;
  return *this;
}

template<>
inline FP_NR<dd_real>& FP_NR<dd_real>::operator=(const char* s) {
  data.read(s, data);
  return *this;
}
...
template<>
inline int FP_NR<dd_real>::fits_slong() const {
  return 1;
}
...
template<>
inline void FP_NR<dd_real>::mul_si(const FP_NR<dd_real>& b, long c) {
